...
public class omrhotel {
   ...
   WebElement checkhotel = driver.findElement(By.xpath("//label[text()='Name Descending']"));
   checkhotel.click();
   Thread.sleep(3000);
      List<WebElement> hotel = driver.findElements(By.xpath("//h5[contains(text(),'Deluxe')]"));
   for (WebElement order : hotel) {
